...
extern ALIGN(RT_ALIGN_SIZE) MENUITEM scr_logo; 

extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_SetTZXS;

extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_CenterTextInfor;

extern ALIGN(RT_ALIGN_SIZE) MENUITEM   Menu_1_Idle; 
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_1_CarSet; 
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_1_InforCheck;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_1_InforInteract;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM Menu_1_InforTirExspd;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM   Menu_1_usb;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_2_1_license;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM   Menu_2_2_2_CarType;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_2_3_SpeedSet;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_2_4_VINset;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_2_5_Cancel;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_2_6_oil;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM Menu_2_3_1_Sing8;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM Menu_2_3_2_sudu;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_3_3_TextInforStor;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_3_4_carinfor;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM Menu_2_3_5_jiayuan;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM Menu_2_3_6_Mileage;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM Menu_2_3_7_CenterInforMeun;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_3_8_Ver;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM Menu_2_4_1_CenterQuestion;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_4_2_CarStatus;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_4_3_CarEleInfor;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_4_4_Multimedia;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM	Menu_2_4_5_Record;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM Menu_2_4_6_CenterAffairSet;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM Menu_2_4_7_LogOut;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM Menu_2_5_1_pilao;
extern ALIGN(RT_ALIGN_SIZE) MENUITEM Menu_2_5_2_chaosu;
...
extern ALIGN(RT_ALIGN_SIZE) MENUITEM *pMenuItem;
